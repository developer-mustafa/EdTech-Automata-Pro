                ...
                <div class="msb-result-summary">
                    <div class="msb-summary-title" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div style="display: flex; gap: 8px;">
                            ...
                            ${showSummaryGroupRank ? `<span class="msb-rank-badge" style="background: #e0f2fe; color: #0284c7; padding: 2px 8px; border-radius: 4px; font-size: 0.7rem; white-space: nowrap; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important;"><i class="fas fa-layer-group"></i> গ্রুপ র‍্যাঙ্ক : ${exactRanks?.groupRank || '-'}</span>` : ''}
                        </div>` : ''}
                    </div>
